...
MainMenubar::MainMenubar(ENIGMA_IDEFrame* frame)
{
    ...
    customToolbarsMenuItem = new wxMenuItem(viewMenu, wxID_ANY, _("Edit"), _("Customize the toolbars"), wxITEM_NORMAL);
    toolbarsMenu->Append(customToolbarsMenuItem);
    customToolbarsMenuItem = new wxMenuItem(viewMenu, wxID_ANY, _("Build"), _("Customize the toolbars"), wxITEM_NORMAL);
    toolbarsMenu->Append(customToolbarsMenuItem);
    customToolbarsMenuItem = new wxMenuItem(viewMenu, wxID_ANY, _("Quick Find"), _("Customize the toolbars"), wxITEM_NORMAL);
    toolbarsMenu->Append(customToolbarsMenuItem);
    customToolbarsMenuItem = new wxMenuItem(viewMenu, wxID_ANY, _("Resources"), _("Customize the toolbars"), wxITEM_NORMAL);
    toolbarsMenu->Append(customToolbarsMenuItem);
